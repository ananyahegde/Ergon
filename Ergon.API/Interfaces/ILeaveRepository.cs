...
namespace Ergon.Interfaces
{
    public interface ILeaveRepository
    {
        ...
        Task<(List<Leave> Items, int TotalCount)> GetPagedLeavesForEmployeesAsync(List<Guid> employeeIds, GetAllLeavesRequest request);
        ...
        Task<(List<LeaveBalanceResponse> Items, int TotalCount)> GetLeaveBalancesAsync(GetLeaveBalancesRequest request);
    }
}
